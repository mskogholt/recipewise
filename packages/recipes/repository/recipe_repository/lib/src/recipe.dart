...
class Recipe extends Equatable {
  ...
  Recipe.empty()
      : id = '', // TODO(mskogholt): Auto generate ids
        title = 'Click to add a title!',
        description =
            'Click here to enter a description about this delicious recipe you will create...',
        imageUrl = '',
        author = 'Unknown',
        ...
        directions = const [
          Direction(
            stepNumber: 1,
            text: 'Click to start adding directions on how to'
                ' prepare the recipe.',
            url: '',
          ),
        ],
